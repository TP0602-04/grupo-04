...
//        game.addInputModification(new Coordinate(1, 1)).toogleMarked();
//        game.addInputModification(new Coordinate(3, 1)).toogleMarked();
//        game.addInputModification(new Coordinate(3, 1)).toogleDirection();
//        game.addInputModification(new Coordinate(5, 1)).toogleMarked();
//        game.addInputModification(new Coordinate(3, 1)).toogleDirection();
...
//            game.addInputModification(new Coordinate(3, 7)).toogleMarked();
//        }
//    }
//}
